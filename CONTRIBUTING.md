...
`git clone git@github.com:seu-usuario/curriculum.git`

Agora pronto, você já pode começar a contribuir com o projeto!

## Reportando Issues

Você pode criar uma issue [aqui](https://github.com/moser-jose/curriculum/issues), mas, lembre-se de ser claro e informar o máximo de detalhes possíveis.
